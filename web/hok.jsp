<%-- 
    Document   : hok
    Created on : Jul 10, 2024, 4:26:17 PM
    Author     : fikri
--%>
...
<div class="container">
        <div class="card">
            <div class="image-container">
                <img src="IMG/honor-of-kings.webp" alt="Honor of Kings">
            </div>
            <div class="content">
                <h1>Honor of Kings</h1>
                <p>Untuk menemukan ID Anda, Klik gambar profilmu dan kamu dapat menemukan user ID kamu di bawah nama profil. (Contoh : 123456789).</p>
            </div>
        </div>
        <div class="right-content">
            <div class="step">
                ...
                <div class="step-body">
                    <input id="riot-id-input" type="text" placeholder="Masukkan User ID (Contoh : 123456789)" required>
                </div>
            </div>
            <div class="step">
                <div class="step-header">
...
<form action="PayServlet" method="post">
    <div id="popup-modal" class="modal">
        <div class="modal-content">
            ...
            <input type="hidden" name="nama_game" value="Honor of Kings">
