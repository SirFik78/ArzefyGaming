...
<div class="container">
        <div class="card">
            <div class="image-container">
                <img src="IMG/wuthering-waves.webp" alt="Mobile Legends">
            </div>
            <div class="content">
        ...
        <div class="right-content">
            ...
            <div class="step">
                ...
                <div class="category">
                    <div class="category-item active" data-category="diamonds"><p>Lunite</p>
                        <img src="IMG/Item_Lunite (1).webp" width="60%" height="100px" alt="Diamonds">
                    </div>
                    <div class="category-item" data-category="starlight"><p>Battle Pass</p>
                        <img src="IMG/GO52xzuWQAA4nRA.jpg_large" width="60%" height="100px" alt="StarLight">
                    </div>
                </div>

                <div class="step-body">
                    <h3>Pilih Genesis Crystal</h3>
...
<form action="PayServlet" method="post">
    <div id="popup-modal" class="modal">
        <div class="modal-content">
            ...
            <input type="hidden" name="nama_game" value="Wuthering Waves">
